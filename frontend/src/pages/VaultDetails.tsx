...
export default function VaultDetails() {
  ...
  // Use automation hooks for real-time updates
  const {
  ...
  const handleGasAdded = () => {
    // Refresh automation status after gas is added
    refreshAutomation();
  };
  ...
  // Check if vault has automation enabled
  const hasAutomation =
    automationStatus &&
    ...
    <>
      <div className="grid lg:grid-cols-3 gap-6">
                  ...
                  <div className="flex items-center space-x-2">
                    {automationStatus?.isPaused ? (
                      <button
                        ...
                        className="brut-btn bg-lime-300 text-sm"
                      ...
                      <button
                        ...
                        className="brut-btn bg-yellow-300 text-sm"
                        disabled={automationLoading}
                      >
                        ⏸️ Pause
                      </button>
        ...
        <div className="space-y-6">
          ...
          {/* Gas Reserve Widget - Show if automation is enabled */}
